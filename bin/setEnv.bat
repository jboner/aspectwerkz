...
set CLASSPATH=%ASPECTWERKZ_HOME%\lib\aspectwerkz-2.1.RC1.jar;%ASPECTWERKZ_HOME%\lib\aspectwerkz-jdk14-2.1.RC1.jar;%ASPECTWERKZ_HOME%\lib\dom4j-1.4.jar;%ASPECTWERKZ_HOME%\lib\concurrent-1.3.1.jar;%ASPECTWERKZ_HOME%\lib\trove-1.0.2.jar;%ASPECTWERKZ_HOME%\lib\jrexx-1.1.1.jar;%ASPECTWERKZ_HOME%\lib\backport175-1.0.RC1.jar;%CLASSPATH%
